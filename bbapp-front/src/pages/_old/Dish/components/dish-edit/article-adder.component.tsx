...
export default function ArticleAdder({ handleArticleAdd, setDisplayArticleAdder }: Props) {
    ...
    const handleArticleCreate = () => {
        ...
        ArticleAPI.create(article).then((articleResponse) => {
    ...
    return (
        <div className={'fixed top-0 left-0 w-full h-full bg-black/40'}>
            <div className={'absolute top-1/4 left-1/2 -translate-x-1/2 w-80 bg-white rounded-xl shadow-xl py-3 px-4 flex flex-col gap-3'}>
