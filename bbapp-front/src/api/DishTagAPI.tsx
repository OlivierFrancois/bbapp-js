...
export class DishTagAPI {
    ...
    static async get(id: number) : Promise<DishTag[]>{
        return axios.get(URL_GET.replace(':tagId', id.toString()))
            .then(res => {
            return res.data
        })
    }
    ...
    static async update(category: DishTag): Promise<DishTag>{
        return axios.put(URL_UPDATE.replace(':tagId', category.id.toString()), {...category})
            .then(res => {
            return res.data
        })
    }
    ...
    static async delete(tagId: number): Promise<void>{
        return axios.delete(URL_DELETE.replace(':tagId', tagId.toString()))
            .then(res => {
                return res.data
            })
    }
